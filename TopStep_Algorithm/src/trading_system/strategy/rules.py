...
from trading_system.core.domain import OrderIntent, OrderType, Regime, Side, TimeInForce
...
def generate_intents(
    ...
    *,
    ...
    for index, row in enumerate(frame.itertuples(index=False)):
        ...
        # exceeds 2× the 50-bar median ATR.
        ...
        # Use 5-min ATR for stop sizing when configured
